...
I also add solutions to the mohamedi/Projects- Mega Project List with software prespective:
...
Algorithms Book [Robert et al.]
-------------
~~**GCD Calculator** -- Calculate the GCD using Euclids algorithm ~~ DONE!!
